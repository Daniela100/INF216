...
var lutador =  new function(){
    ...
    this.estados[1] = new Estado(0,6,0,0,400);
    ...
    this.desenha = function(){
        ...
        try {
            ...
            ctx.drawImage(this.agente.img, sx, 0 ,this.agente.width,this.agente.height,
                this.agente.x+this.estados[1].transx, this.agente.y+this.estados[1].transy, this.agente.width,this.agente.height); 
            ctx.restore();
